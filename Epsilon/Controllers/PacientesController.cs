...
namespace Epsilon.Controllers
{
    public class PacientesController : AbstractSecurityController
    {
        ...
        public PacientesController(ILogger<PacientesController> logger, ISeguridad seguridad, IGestionUsuarios gestionUsuarios, IRazorRenderService renderService) : base(logger, seguridad)
        {
